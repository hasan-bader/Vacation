...
class UserController {
  ...
  static addNewUser(req, res) {
    let sql = `INSERT INTO users (first_name, last_name, password, user_name) VALUES ('${req.query.firstName}', '${req.query.lastName}', '${req.query.password}', '${req.query.userName}')`;
  ...
  static loginUser(req, res) {
    let sql = `SELECT * FROM users  WHERE user_name = '${req.query.userName}'`;
